...
struct node *IAB(struct node *head,int len){
...
struct node *IAE(struct node *head,int len){
	struct node *a=(struct node *)malloc(sizeof(struct node) );
	struct node *node1=createnode();
	putdata(node1);
	if (len==0){
...
struct node *DFB(struct node *head,int len){
	if(len==1){
		struct node *a=(struct node *)malloc(sizeof(struct node) );
		free(head);
		len-=1;
...
struct node *DFE(struct node *tail,int len){
	if(len==1){
		struct node *a=(struct node *)malloc(sizeof(struct node) );
		free(tail);
		len-=1;
